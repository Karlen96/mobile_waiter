...
class InitialMigration {
  static Future<void> initInitialTables(Database db) async {
    ...
    db.execute(
        'CREATE TABLE ${TableNames.orders} (id INTEGER, table_id INTEGER, product_id INTEGER, product_name TEXT, product_price DOUBLE, product_count INTEGER, category_name TEXT, category_id INTEGER, isFinished BOOLEAN);');
